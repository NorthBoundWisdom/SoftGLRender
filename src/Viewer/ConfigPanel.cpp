...
void ConfigPanel::drawSettings()
{
    ...
    if (!config_.wireframe)
    {
        ...
        ImGui::ColorEdit3("ambient color", (float *)&config_.ambientColor,
        ...
        if (config_.showLight)
        {
            ...
            ImGui::ColorEdit3("light color", (float *)&config_.pointLightColor,
                              ImGuiColorEditFlags_NoLabel);
...
void ConfigPanel::update()
{
    ...
    config_.pointLightPosition =
        2.f * glm::vec3(glm::sin(lightPositionAngle_), 1.2f, glm::cos(lightPositionAngle_));
    if (updateLightFunc_)
    {
