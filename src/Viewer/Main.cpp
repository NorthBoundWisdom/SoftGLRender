...
static std::shared_ptr<SoftGL::View::ViewerManager> viewer = nullptr;
...
int main()
{
    ...
    GLFWwindow *window =
        glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "SoftGLRenderer", nullptr, nullptr);
    if (!window)
    {
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8, SCR_WIDTH, SCR_HEIGHT, 0, GL_RGBA, GL_UNSIGNED_BYTE,
                 nullptr);
