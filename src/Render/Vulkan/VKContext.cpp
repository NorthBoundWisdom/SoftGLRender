...
bool VKContext::setupDebugMessenger()
{
    ...
    {
        ret = VKLoader::vkCreateDebugUtilsMessengerEXT(instance_, &createInfo, nullptr,
                                                       &debugMessenger_);
    }
    else
    {
                                ...
                                VkBufferUsageFlags usage)
{
    ...
    VK_CHECK(vmaCreateBuffer(allocator_, &bufferInfo, &allocInfo, &buffer.buffer,
                             &buffer.allocation, &buffer.allocInfo));
}
