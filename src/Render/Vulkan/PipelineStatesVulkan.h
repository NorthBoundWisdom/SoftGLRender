...
public:
                ...
                VkRenderPass &renderPass, VkSampleCountFlagBits sampleCount)
    {
        ...
        {
            currPipeline_ =
                createGraphicsPipeline(vertexInputInfo, program, renderPass, sampleCount);
...
private:
    PipelineContainerVK
    createGraphicsPipeline(VkPipelineVertexInputStateCreateInfo &vertexInputInfo,
                           ...
                           VkSampleCountFlagBits sampleCount)
    {
        ...
        colorBlendAttachment.colorBlendOp =
            VK::cvtBlendFunction(renderStates.blendParams.blendFuncRgb);
        ...
        VK_CHECK(
            vkCreatePipelineLayout(device_, &pipelineLayoutInfo, nullptr, &ret.pipelineLayout_));
