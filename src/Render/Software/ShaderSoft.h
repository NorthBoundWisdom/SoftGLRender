...
public:
    ...
    static inline glm::vec4 textureLod(Sampler2DSoft<RGBA> *sampler, glm::vec2 coord,
                                       float lod = 0.f)
    {
    ...
    static inline glm::vec4 textureLod(SamplerCubeSoft<RGBA> *sampler, glm::vec3 coord,
                                       float lod = 0.f)
    {
    ...
    static inline glm::vec4 textureLodOffset(Sampler2DSoft<RGBA> *sampler, glm::vec2 coord,
                                             float lod, glm::ivec2 offset)
    {
