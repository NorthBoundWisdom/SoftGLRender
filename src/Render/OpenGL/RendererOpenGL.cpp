...
RendererOpenGL::createVertexArrayObject(const VertexArray &vertexArray)
{
...
RendererOpenGL::createPipelineStates(const RenderStates &renderStates)
{
...
// pipeline
void RendererOpenGL::beginRenderPass(std::shared_ptr<FrameBuffer> &frameBuffer,
                                     const ClearStates &states)
{
  ...
  if (states.colorFlag)
  {
    GL_CHECK(glClearColor(states.clearColor.r, states.clearColor.g, states.clearColor.b,
                          states.clearColor.a));
...
void RendererOpenGL::setPipelineStates(std::shared_ptr<PipelineStates> &states)
{
  ...
  GL_CHECK(
    glBlendEquationSeparate(OpenGL::cvtBlendFunction(renderStates.blendParams.blendFuncRgb),
